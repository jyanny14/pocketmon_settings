...
const STRINGS = {
  ko: {
    ...
    "index.howTo.step1.title": "1. 데이터 둘러보기",
    "index.howTo.step1.body": "포켓몬 · 도구 · 특성 · 기술 네 탭에서 한/영 이름으로 검색. 타입 · 분류 · 종족값 · Champions 재밸런스 플래그로 필터링·정렬 가능.",
    "index.howTo.step2.title": "2. 파티 구성",
    "index.howTo.step2.body": "파티 빌더에서 슬롯을 클릭해 포켓몬·폼·특성·도구 선택. \"상세 설정\" 을 열면 4기술 · Stat Points 6스탯 · 성격까지 지정. 분석 패널에 종족값/실효 스탯 합계 · 타입 커버리지 · HOME 연동 게임 노출.",
    "index.howTo.step3.title": "3. 공유 · 저장",
    "index.howTo.step3.body": "\"URL 복사\" 로 어디서든 같은 구성 재현. \"로컬 저장\" 으로 브라우저에 여러 파티 보관. 헤더 좌상단 토글로 한/영 즉시 전환.",
    "index.howTo.step4.title": "4. AI 분석",
    "index.howTo.step4.body": "\"AI 분석\" 버튼 → 6개 템플릿 (약점 · 교체 · 기술 조합 · 남은 슬롯 · 상대 파티 · 자유 질문) 중 선택해 복사. URL fetch 를 못 하는 AI 는 Champions 데이터 파일을 함께 다운로드해 채팅에 첨부하고 프롬프트는 별도 복사.",
  ...
  en: {
    ...
    "index.howTo.step1.title": "1. Browse the data",
    "index.howTo.step1.body": "Search Pokémon · items · abilities · moves across four tabs by Korean or English name. Filter and sort by type, category, base stats, and Champions rebalance flags.",
    "index.howTo.step2.title": "2. Build a party",
    "index.howTo.step2.body": "In the Party Builder, click a slot to pick a Pokémon, form, ability, and item. Expand \"Advanced\" to set 4 moves, stat points across 6 stats, and a nature. The analysis panel shows base/effective stat totals, type coverage, and HOME-compatible games.",
    "index.howTo.step3.title": "3. Share · save",
    "index.howTo.step3.body": "\"Copy URL\" reproduces the same party anywhere. \"Save locally\" keeps multiple parties in your browser. The toggle at the top-left of the header switches between Korean and English instantly.",
    "index.howTo.step4.title": "4. Ask AI",
    "index.howTo.step4.body": "The \"AI analysis\" button opens six templates (weakness · swap · moveset · fill · counter · free-form). If your AI can't fetch URLs, download the Champions data file, attach it to the chat, and paste the prompt separately.",
