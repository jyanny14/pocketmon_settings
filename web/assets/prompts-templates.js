...
3. **Everything that exists in Pokémon Champions** is contained in the sources above. **Your prior knowledge has a very high chance of being wrong here.** Champions has a **different lineup** from the main games (Scarlet/Violet, Legends: Z-A, etc.). Many Pokémon/abilities/items/moves from the main series are absent, and 16 moves have different numbers. If it's not in the sources above, treat it as not existing in Champions. Common wrong guesses: \`assault-vest\`, \`leftovers\`, etc. — if they're not in items.json, **do NOT recommend them**, even though they're popular in the main series.
